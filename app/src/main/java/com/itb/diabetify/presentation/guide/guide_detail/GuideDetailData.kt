    ...
    "about_diabetes" to GuideDetailData(
        ...
        content = listOf(
            GuideSection(
                ...
                content = """Diabetes adalah kondisi kronis yang terjadi ketika tubuh tidak dapat menghasilkan insulin yang cukup atau tidak dapat menggunakan insulin secara efektif. Insulin adalah hormon yang diproduksi oleh pankreas yang memungkinkan glukosa dari makanan masuk ke dalam sel-sel tubuh untuk diubah menjadi energi.
    ...
    "risk_factors" to GuideDetailData(
        ...
        content = listOf(
            GuideSection(
                ...
                content = """1. Indeks Massa Tubuh (IMT)
